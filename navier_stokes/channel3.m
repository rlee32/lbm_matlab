...
for iter = 1:timesteps
    ...
    f(2:end-1,end,4) = f(2:end-1,end-1,4); % East outlet (extrapolation).
    f(2:end-1,end,8) = f(2:end-1,end-1,8); % East outlet (extrapolation).
    f(2:end-1,end,7) = f(2:end-1,end-1,7); % East outlet (extrapolation).
